...
export function useWaterFloorControls() {
  return useControls(
    "Water Floor",
    {
      ...
      midColor:       { value: "#3FA9F5",                                  label: "Mid Color" },
      midPos:         { value: 0.15,  min: 0.001, max: 0.999, step: 0.001, label: "Mid Pos" },
      ...
      fadeDistance:   { value: 600,    min: 10,    max: 1000, step: 5,     label: "Fade Distance" },
