...
export function useWaterFloorControls() {
  return useControls(
    "Water Floor",
    {
      ...
      deepColor:      { value: "#0047ab",                                  label: "Deep Color" },
      midColor:       { value: "#00bfff",                                  label: "Mid Color" },
      midPos:         { value: 0.25,  min: 0.001, max: 0.999, step: 0.001, label: "Mid Pos" },
      highlightColor: { value: "#ffffff",                                  label: "Highlight Color" },
      opacity:        { value: 1.0,   min: 0,    max: 1,    step: 0.01,  label: "Opacity" },
      deepOpacity:    { value: 0.40,  min: 0,    max: 1,    step: 0.01,  label: "Deep Opacity" },
      fadeDistance:   { value: 300,   min: 10,   max: 500,  step: 5,     label: "Fade Distance" },
